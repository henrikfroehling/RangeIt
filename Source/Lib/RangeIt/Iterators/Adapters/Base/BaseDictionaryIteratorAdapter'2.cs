namespace RangeIt.Iterators.Adapters.Base
{
    ...
    internal abstract class BaseDictionaryIteratorAdapter<T, U> : IIterable, IEnumerable<KeyValuePair<T, U>>
    {
        protected Dictionary<T, U> _dictionary;
        ...
        internal BaseDictionaryIteratorAdapter(Dictionary<T, U> dictionary, bool isEnd = false)
        {
