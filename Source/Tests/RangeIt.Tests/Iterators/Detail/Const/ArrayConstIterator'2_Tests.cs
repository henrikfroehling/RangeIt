namespace RangeIt.Tests.Iterators.Detail.Const
{
    ...
    [Collection("ArrayConstIterator<T, U>.Tests")]
    public class ArrayConstIterator_2_Tests
    {
        [Fact]
        public void Test_ArrayConstIterator_2_Begin_Ctor_WithEmptyArray()
        {
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_End_Ctor_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_Begin_Iteration_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            var it = array.ConstBegin();
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_End_Iteration_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            var it = array.ConstEnd();
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_Begin_Ctor_WithNotEmptyArray()
        {
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_End_Ctor_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_Begin_Iteration_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_End_Iteration_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_Begin_IsValid()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayConstIterator_2_End_IsValid()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
