namespace RangeIt.Tests.Iterators.Detail.NotConst
{
    ...
    {
        [Fact]
        public void Test_ArrayIterator_1_Begin_Ctor_WithEmptyArray()
        {
            var array = new int[0];
            var it = array.Begin();
        ...
        [Fact]
        public void Test_ArrayIterator_1_End_Ctor_WithEmptyArray()
        {
            var array = new int[0];
            var it = array.End();
        ...
        [Fact]
        public void Test_ArrayIterator_1_Begin_Iteration_WithEmptyArray()
        {
            var array = new int[0];
            var it = array.Begin();
        ...
        [Fact]
        public void Test_ArrayIterator_1_End_Iteration_WithEmptyArray()
        {
            var array = new int[0];
            var it = array.End();
        ...
        [Fact]
        public void Test_ArrayIterator_1_Begin_Ctor_WithNotEmptyArray()
        {
        ...
        [Fact]
        public void Test_ArrayIterator_1_End_Ctor_WithNotEmptyArray()
        {
            var array = new int[] { 1, 2, 3, 4, 5 };
            var it = array.End();
        ...
        [Fact]
        public void Test_ArrayIterator_1_Begin_Iteration_WithNotEmptyArray()
        {
            var array = new int[] { 1, 2, 3, 4, 5 };
            var it = array.Begin();
        ...
        [Fact]
        public void Test_ArrayIterator_1_End_Iteration_WithNotEmptyArray()
        {
            var array = new int[] { 1, 2, 3, 4, 5 };
            var it = array.End();
