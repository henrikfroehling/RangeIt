namespace RangeIt.Tests.Iterators.Detail.NotConst
{
    ...
    [Collection("SortedListIterator<T>.Tests")]
    public class SortedListIterator_Tests
    {
        ...
        [Fact]
        public void Test_SortedListIterator_1_Begin_Assignment()
        {
            var sortedList = new SortedList();
            sortedList.Add("a", "a");
            sortedList.Add("b", "b");
        ...
        [Fact]
        public void Test_SortedListIterator_1_End_Assignment()
        {
            var sortedList = new SortedList();
            sortedList.Add("a", "a");
            sortedList.Add("b", "b");
        ...
        [Fact]
        public void Test_SortedListIterator_1_Begin_Assignment_IndexOutOfBound()
        {
            var sortedList = new SortedList();
            sortedList.Add("a", "a");
            sortedList.Add("b", "b");
        ...
        [Fact]
        public void Test_SortedListIterator_1_Begin_IsValid()
        {
            var sortedList = new SortedList();
            sortedList.Add("a", "a");
            sortedList.Add("b", "b");
        ...
        [Fact]
        public void Test_SortedListIterator_1_End_IsValid()
        {
            var sortedList = new SortedList();
            sortedList.Add("a", "a");
            sortedList.Add("b", "b");
