namespace RangeIt.Tests.Iterators.Detail.NotConst
{
    ...
    {
        [Fact]
        public void Test_ListIterator_1_Begin_Ctor_WithEmptyList()
        {
        ...
        [Fact]
        public void Test_ListIterator_1_End_Ctor_WithEmptyList()
        {
            var list = new List<int>();
            var it = list.End();
        ...
        [Fact]
        public void Test_ListIterator_1_Begin_Iteration_WithEmptyList()
        {
            var list = new List<int>();
            var it = list.Begin();
        ...
        [Fact]
        public void Test_ListIterator_1_End_Iteration_WithEmptyList()
        {
            var list = new List<int>();
            var it = list.End();
        ...
        [Fact]
        public void Test_ListIterator_1_Begin_Ctor_WithNotEmptyList()
        {
        ...
        [Fact]
        public void Test_ListIterator_1_End_Ctor_WithNotEmptyList()
        {
            var list = new List<int> { 1, 2, 3, 4, 5 };
            var it = list.End();
        ...
        [Fact]
        public void Test_ListIterator_1_Begin_Iteration_WithNotEmptyList()
        {
            var list = new List<int> { 1, 2, 3, 4, 5 };
            var it = list.Begin();
        ...
        [Fact]
        public void Test_ListIterator_1_End_Iteration_WithNotEmptyList()
        {
            var list = new List<int> { 1, 2, 3, 4, 5 };
            var it = list.End();
