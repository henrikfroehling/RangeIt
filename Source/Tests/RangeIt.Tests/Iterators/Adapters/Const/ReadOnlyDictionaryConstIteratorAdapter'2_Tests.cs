namespace RangeIt.Tests.Iterators.Adapters.Const
{
    ...
    {
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_Begin_Ctor_WithEmptyDictionary()
        {
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_End_Ctor_WithEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>();
            var readOnlyDictionary = new ReadOnlyDictionary<string, int>(dictionary);
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_Begin_Iteration_WithEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>();
            var readOnlyDictionary = new ReadOnlyDictionary<string, int>(dictionary);
            ConstIterator<string, int> it = readOnlyDictionary.ConstBegin();
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_End_Iteration_WithEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>();
            var readOnlyDictionary = new ReadOnlyDictionary<string, int>(dictionary);
            ConstIterator<string, int> it = readOnlyDictionary.ConstEnd();
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_Begin_Ctor_WithNotEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_End_Ctor_WithNotEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_Begin_Iteration_WithNotEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_End_Iteration_WithNotEmptyDictionary()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_Begin_IsValid()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
        ...
        [Fact]
        public void Test_ReadOnlyDictionaryConstIteratorAdapter_2_End_IsValid()
        {
            var dictionary = new Dictionary<string, int>
            {
                ["one"] = 1,
