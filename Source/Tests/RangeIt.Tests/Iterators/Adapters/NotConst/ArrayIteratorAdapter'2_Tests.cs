namespace RangeIt.Tests.Iterators.Adapters.NotConst
{
    ...
    [Category("Iterators.Adapters.NotConst.ArrayIteratorAdapter<T, U>")]
    public class ArrayIteratorAdapter_2_Tests
    {
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Ctor_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            Iterator<string, int> it = array.Begin();
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_Ctor_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            Iterator<string, int> it = array.End();
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Iteration_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            Iterator<string, int> it = array.Begin();
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_Iteration_WithEmptyArray()
        {
            var array = new KeyValuePair<string, int>[0];
            Iterator<string, int> it = array.End();
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Ctor_WithNotEmptyArray()
        {
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_Ctor_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Iteration_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_Iteration_WithNotEmptyArray()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Assignment()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_Assignment()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_Assignment_IndexOutOfBound()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_Begin_IsValid()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
        ...
        [Fact]
        public void Test_ArrayIteratorAdapter_2_End_IsValid()
        {
            var array = new KeyValuePair<string, int>[]
            {
                new KeyValuePair<string, int>("one", 1),
